...
int member_list0()
{
    ...
    strcpy(m[0].mname," c\t");
    strcpy(m[0].address," Denis\t");
    m[0].num=01715221424;

    strcpy(m[1].mname," c\t");
    strcpy(m[1].address," Denis\t");
    m[1].num=0171522424;

    strcpy(m[2].mname," c\t");
    strcpy(m[2].address," Denis\t");
    m[2].num=44444444444;

    strcpy(m[3].mname," c\t");
    strcpy(m[3].address," Denis\t");
    m[3].num=4444444444;

    strcpy(m[4].mname," c\t");
    strcpy(m[4].address," Denis\t");
    m[4].num=4444444444444;
}
...
int member_list()
{
    ...
    for(i=0; i<book_count; i++)
    {
        printf("     %d     %s              %s               %d            \n",i,m[0].mname,m[0].address,m[0].num);
    }
    printf(" Press 0 for back to main menu ...");
    scanf("%d",&a);
    if(a==0)
